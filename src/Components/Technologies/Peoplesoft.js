    ...
    return (
        <div>
            ...
            <Technology heading="Peoplesoft" img={require('../Images/tech/peoplesoft.jpg').default}>
                <p>In today’s complex business operations, we understand the need of adopting new technologies to simplify the business processes and strive to fulfill this need. Grovita Technology PeopleSoft solutions are well designed to meet all our clients’ complex business requirements that enable organizations to seed up business productivity, improve operational efficiencies and increase ROI.</p>
