    ...
    return (
        <div>
            ...
            <Technology heading="Hyperion" img={require('../Images/tech/hyperion.jpg').default}>
                ...
                <p>Grovita Technology Oracle Hyperion Practice engages with customers in all these applications in advisory, consultative, implementation and support roles. In-house solutions are built using best practices and industry expertise to accelerate a typical implementation cycle.</p>
            </Technology>
        </div>
    )
}
