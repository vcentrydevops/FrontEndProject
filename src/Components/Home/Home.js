                ...
                <div className="serv-div">
                    <div>
                        ...
                        <div>
                            ...
                            <NavLink to="/services/application_development" onClick={scrollUp}><p>As competition to innovate and integrate through an agile platform (App) is growing, Grovita Technology turns impeccable with 10+ year expertise.</p></NavLink>
                        </div>
                    </div>
                    <div>
                        <div className="icon-div">
                        ...
                        <div>
                            ...
                            <NavLink to="/services/mobile_app_development" onClick={scrollUp}><p>Handling every level of complexity in Mobile App Development using .NET, Java, PHP, Node.js on various platforms, Grovita Technology is reliable.</p></NavLink>
                        </div>
                    </div>
                    <div>
                        <div className="icon-div">
                        ...
                        <div>
                            ...
                            <NavLink to="/services/software_testing" onClick={scrollUp}><p>Believing in a customer-centric approach, Grovita Technology is delivering superior services with utmost priority to their Testing & QA.</p></NavLink>
                        </div>
                    </div>
                    <div>
                        <div className="icon-div">
                        ...
                        <div>
                            ...
                            <NavLink to="/services/digital_marketing" onClick={scrollUp}><p>Digital Marketing has turned up a boon for branding now. Offering it with aggressive trends in the market, Grovita Technology is your next stop.</p></NavLink>
                        </div>
                    </div>
                    <div>
                        <div className="icon-div">
                        ...
                        <div>
                            ...
                            <NavLink to="/services/it_infrastructure" onClick={scrollUp}><p>With multiple domain experience of Infrastructure services, Grovita Technology promises operational excellence to reach customer’s resilience expectations.</p></NavLink>
                        </div>
                    </div>
                    <div>
                        <div className="icon-div">
                        ...
                        <div>
                            ...
                            <NavLink to="/services/it_staffing" onClick={scrollUp}><p>Companies are looking for the most competent & credible professionals to sustain in Industry. At Grovita Technology, we bridge you with a right source.</p></NavLink>
                        </div>
                    </div>
                </div>
            </div>
