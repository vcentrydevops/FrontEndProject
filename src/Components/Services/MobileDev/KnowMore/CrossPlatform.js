        ...
        <div>
            ...
            <div className="app-dev-cont3 know-cont1">
                <ServiceComponent heading="Cross-Platform Application Services">
                    ...
                    <p>With a detailed prowess in Application Development Services, Amtex Info Solutions is providing cost-effective, time-saving and reliable cross-platform application services over the cost-binding native apps since then.</p>
                    ...
                    <p>Thus, providing best End-to-End mobility, UX/UI design, App Porting, Testing QA, App maintenance & support, and App marketing services for Cross-platform Applications Amtex Info Solutions holds the trust of globally successful companies since 10 years.</p>
                </ServiceComponent>
            </div>
            <MobCommon></MobCommon>
        </div>
