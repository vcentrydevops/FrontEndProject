        ...
        <div>
            ...
            <div className="app-dev-cont3 know-cont1">
                <ServiceComponent heading="IOS Application Services">
                  <p>In a fast pacing Application Development market, Amtex Info Solutions is renowned for its expertise in Mobile Application Development and Marketing Services from 10+ years.</p>
                  ...
                  <p>So, far Amtex Info Solutions has extended its IOS Application Development Services into Gaming, Social media intig. , AR, Messaging, and is looking into more advanced/newly-introduced categories too.</p>
                </ServiceComponent>
            </div>
            <MobCommon></MobCommon>
        </div>
