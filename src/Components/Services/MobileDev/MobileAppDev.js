...
export default function MobileAppDev() {
    ...
    const div6Data=[
        {
            head:"Android Application development",
            img:require('../../Images/services/webAppDev.png').default,
        },
        {
            head:"IOS Application development",
            img:require('../../Images/services/mobileAppDev.png').default,
        },
        {
            head:"Cross platform mobile application",
    ...
    return (
        <div>
            ...
            <div className="mob-app-cont6">
                <ServImgCont heading="Technologies we use" dataArray={div6Data}>
                </ServImgCont>
            </div>
